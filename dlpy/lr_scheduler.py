...
class FCMPLR(_LRScheduler):
    """
    FCMP learning rate scheduler object
...
class FixedLR(_LRScheduler):
    """
    Fixed learning rate scheduler object
...
class StepLR(_LRScheduler):
    """
    Step learning rate scheduler object
...
class MultiStepLR(_LRScheduler):
    """
    Multiple steps learning rate scheduler object
...
class PolynomialLR(_LRScheduler):
    """
    Polynomial learning rate scheduler object
...
class ReduceLROnPlateau(FCMPLR):
    """
    Reduce learning rate on plateau learning rate scheduler object
...
class CyclicLR(FCMPLR):
    """
    Cyclic learning rate scheduler object
